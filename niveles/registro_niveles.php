...
<body bgcolor="black">
    <form class="multiplecolumn" method="post" id="guardar" action="" width="80%">
        ...
        <fieldset style="background-color:#ffffff00; width:30% ;text-align: center; ">
            ...
            <table>
                <tr>
                    <td ><input type="button" class="button" onClick="location.href='nivel_uno.php'" name="primer_nivel" value="PRIMER NIVEL" /></td>
                </tr>
                <tr>
                    <td><input type="button" class="button" onClick="location.href='nivel_dos.php'" name="primer_nivel" value="SEGUNDO NIVEL" /></td>
                </tr>
                <tr>
                    <td><input type="button" class="button" onClick="" name="primer_nivel" value="TERCER NIVEL" /></td>
                </tr>   
            </table>
        </fieldset>
    </form>
